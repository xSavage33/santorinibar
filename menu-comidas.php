...
// Obtener categorías activas del menú de comidas
$stmtCat = $db->prepare("SELECT * FROM categorias WHERE activo = 1 AND tipo_menu = 'comidas' ORDER BY orden");
$stmtCat->execute();
...
$stmtSub = $db->prepare("SELECT s.*, c.nombre as categoria_nombre
    ...
    WHERE s.activo = 1 AND c.tipo_menu = 'comidas' AND c.activo = 1
...
$stmtProd = $db->prepare("SELECT p.*, s.nombre as subcategoria_nombre, s.id as subcategoria_id
    ...
    JOIN categorias c ON s.categoria_id = c.id
    WHERE p.activo = 1 AND c.tipo_menu = 'comidas' AND c.activo = 1
...
<head>
    ...
    <title>Comidas | Santorini Restobar</title>
...
<body data-theme="comidas">
    ...
    <header class="menu-header">
        <div class="header-container">
            ...
            <a href="menu-licores.php" class="switch-menu">
    ...
    <section class="menu-hero">
        <div class="hero-content">
            ...
            <h2 class="hero-title">Nuestro Menu</h2>
            <p class="hero-description">Comidas rápidas, snacks y bebidas refrescantes</p>
        </div>
        ...
        <div class="content-container">
            ...
            <section class="coming-soon">
                <div class="coming-soon-content">
                    ...
                    <h3>Proximamente</h3>
                    <p>Estamos preparando un menu delicioso para ti.</p>
                    <p>Muy pronto podras disfrutar de hamburguesas, perros, suizos y mucho más.</p>
                    <a href="menu-licores.php" class="coming-btn">
                        <i class="fas fa-wine-glass-alt"></i>
